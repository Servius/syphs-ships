...
ENT.EntModel = "models/eta2y/eta2y1.mdl"
ENT.Vehicle = "EtaY"
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNetworkedEntity("EtaY", NULL)
	...
	hook.Add("CalcView", "EtaYView", CalcView)
	
	local HUD = surface.GetTextureID("vgui/eta_cockpit");
	function EtaYReticle()
		
		local p = LocalPlayer();
		local Flying = p:GetNWBool("FlyingEtaY");
		local self = p:GetNWEntity("EtaY");
	...
	hook.Add("HUDPaint", "EtaYReticle", EtaYReticle)
